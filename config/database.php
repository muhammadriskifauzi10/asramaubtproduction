    ...
    */
    ...
    'connections' => [
        ...
        'mysql_sidara' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SIDARA', '127.0.0.1'),
            'port' => env('DB_PORT_SIDARA', '3306'),
            'database' => env('DB_DATABASE_SIDARA', 'forge'),
            'username' => env('DB_USERNAME_SIDARA', 'forge'),
            'password' => env('DB_PASSWORD_SIDARA', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
