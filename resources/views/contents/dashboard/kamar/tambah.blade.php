        ...
        <div class="card mb-4 border-0" style="background-color: rgb(227 255 230)">
            <div class="card-body">
                <div class="row mb-3 justify-content-center">
                    <div class="col-xl-8">
                        <form action="{{ route('kamar.post') }}" method="POST" autocomplete="off">
                            @csrf
                            {{-- token listrik --}}
                            <div class="row mb-3">
                                <label for="token_listrik" class="col-xl-2 col-form-label fw-bold">Token Listrik</label>
                                <div class="col-xl-10">
                                    <input type="text" name="token_listrik" class="form-control"
                                        placeholder="Masukkan nomor token listrik" value="{{ old('token_listrik') }}"
                                        id="token_listrik" autofocus />
                                </div>
                            </div>
                            {{-- type --}}
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-10">
                                    <input type="text" name="nomor_kamar"
                                        ...
                                        placeholder="Masukkan nomor kamar / nama kamar" value="{{ old('nomor_kamar') }}"
                                        id="nomor_kamar" />
                                    @error('nomor_kamar')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-10">
                                    <input type="number" name="kapasitas"
                                        ...
                                        placeholder="Masukkan jumlah kapasitas kamar" value="{{ old('kapasitas') }}"
                                        id="kapasitas" />
                                    @error('kapasitas')
                                        <div class="invalid-feedback">
                                            {{ $message }}
