        ...
        <div class="card mb-4 border-0" style="background-color: rgb(227 255 230)">
            <div class="card-body">
                <div class="row mb-3 justify-content-center">
                    <div class="col-xl-8">
                        <form action="{{ route('harga.update', encrypt($dataharga->id)) }}" method="POST"
                            autocomplete="off">
                            @method('PUT')
                            @csrf
                            {{-- tagih --}}
                                ...
                                <div class="col-xl-10">
                                    <select name="tagih"
                                        ...
                                        @foreach (\App\Models\Tagih::all() as $row)
                                            <option value="{{ $row->id }}"
                                                {{ old('tagih', $dataharga->tagihan->id) == $row->id ? 'selected' : '' }}>
                                                {{ $row->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-10">
                                    <input type="text" name="nama_tagihan"
                                        ...
                                        value="{{ old('nama_tagihan', $dataharga->nama_tagihan) }}" id="nama_tagihan" />
                                    @error('nama_tagihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-xl-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="harga" id="harga"
                                            ...
                                            value="{{ old('harga', intval($dataharga->harga)) }}">
                                    </div>
                                    @error('harga')
