    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4 border-0" style="background-color: rgb(227 255 230)">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-xl-12">
                        <table class="table m-0" id="datatableverifikasipermintaankamar" style="width: 100%">
...
@push('myscripts')
    <script>
        ...
        $(document).ready(function() {
            table = $("#datatableverifikasipermintaankamar").DataTable({
                processing: true,
                paging: false,
                ajax: {
                    url: "{{ route('request.verifikasipermintaankamar.datatableverifikasipermintaankamar') }}",
                    type: "POST",
                    // dataSrc: ""
                    dataType: "json",
                },
