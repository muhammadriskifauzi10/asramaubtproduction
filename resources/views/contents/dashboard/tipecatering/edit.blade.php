        ...
        <div class="card mb-4 border-0" style="background-color: rgb(227 255 230)">
            <div class="card-body">
                <div class="row mb-3 justify-content-center">
                    <div class="col-xl-8">
                        <form action="{{ route('tipecatering.update', encrypt($datatipecatering->id)) }}" method="POST"
                            autocomplete="off">
                            @method('PUT')
                            @csrf
                            {{-- jenis tagih --}}
                                ...
                                <div class="col-xl-10">
                                    <select name="jenis_tagih"
                                        ...
                                        @foreach (\App\Models\Harga::where('tagih_id', 2)->get() as $row)
                                            <option value="{{ $row->id }}"
                                                {{ old('jenis_tagih', $datatipecatering->harga_id) == $row->id ? 'selected' : '' }}>
                                                {{ $row->nama_tagihan }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-10">
                                    <input type="text" name="tipe_catering"
                                        ...
                                        placeholder="Masukkan nama tipe catering"
                                        value="{{ old('tipe_catering', $datatipecatering->nama) }}" id="tipe_catering" />
                                    @error('tipe_catering')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-xl-10">
                                    <input type="number" name="jumlah_porsi"
                                        ...
                                        value="{{ old('jumlah_porsi', $datatipecatering->jumlah_porsi) }}"
                                        id="jumlah_porsi" />
                                    @error('jumlah_porsi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-xl-10">
                                    <div class="form-check form-check-inline">
                                        <input class="@error('pagi') is-invalid @enderror" type="radio" name="pagi"
                                            id="pagi_y" value="Y"
                                            {{ old('pagi', $datatipecatering->pagi) == 'Y' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="@error('pagi') is-invalid @enderror" type="radio" name="pagi"
                                            id="pagi_t" value="T"
                                            {{ old('pagi', $datatipecatering->pagi) == 'T' ? 'checked' : '' }}>
                                ...
                                <div class="col-xl-10">
                                    <div class="form-check form-check-inline">
                                        <input class="@error('siang') is-invalid @enderror" type="radio" name="siang"
                                            id="siang_y" value="Y"
                                            {{ old('siang', $datatipecatering->siang) == 'Y' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="@error('siang') is-invalid @enderror" type="radio" name="siang"
                                            id="siang_t" value="T"
                                            {{ old('siang', $datatipecatering->siang) == 'T' ? 'checked' : '' }}>
                                ...
                                <div class="col-xl-10">
                                    <div class="form-check form-check-inline">
                                        <input class="@error('malam') is-invalid @enderror" type="radio" name="malam"
                                            id="malam_y" value="Y"
                                            {{ old('malam', $datatipecatering->malam) == 'Y' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="@error('malam') is-invalid @enderror" type="radio" name="malam"
                                            id="malam_t" value="T"
                                            {{ old('malam', $datatipecatering->malam) == 'T' ? 'checked' : '' }}>
